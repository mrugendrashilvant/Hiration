...
import image from '../../assets/Group 2530.png'
    ...
    return (
        <div className='container mx-auto w-11/12'>
            <div className="flex justify-between items-center">
                <div className='w-2/4'>
                    <img className='rounded-lg' src={image} alt="resume" />
                </div>
                ...
                <div className="right w-2/4">
                    ...
                    <button style={{ backgroundColor: "#FF9313" }} className='mt-6 leading-5 text-xs rounded-md bg-orange-500 px-4 py-3 duration-100 text-white hover:underline'>Review Your Resume</button>
