...
export default function () {
    return (
        <div className='container mx-auto w-11/12'>
            <div style={{ backgroundColor: "#FFE3B2", boxShadow: "0px 12px 20px 10px rgba(0, 0, 0, 0.07)" }} className="mt-10 px-12 py-8 flex justify-between items-start mx-auto rounded-xl">
                <div className="left">
